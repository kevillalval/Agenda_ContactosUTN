            ...
            if (isEditMode){
                // Edición
                 dbHelper.updateContact(
                        ...
                        ""+note,
                        ""+addedTime,
                         ""+timeStamp // El tiempo de actualización será el nuevo tiempo
                );

                Toast.makeText(getApplicationContext(), "ACTUALIZACIÓN SATISFACTORIA", Toast.LENGTH_SHORT).show();
                ...
                Toast.makeText(getApplicationContext(), "CONTACTO REGISTRADO EXITOSAMENTE"+id, Toast.LENGTH_SHORT).show();
            }

        }else {
            Toast.makeText(getApplicationContext(), "INGRESE UN CONTACTO ANTES DE GUARDAR", Toast.LENGTH_SHORT).show();
        }
            ...
            case CAMERA_PERMISSION_CODE:
                if (grantResults.length >0){
                    ...
                    if (cameraAccepted && storageAccepted){
                        ...
                        Toast.makeText(getApplicationContext(), "Se necesita permiso de la camara y almacenamiento", Toast.LENGTH_SHORT).show();
                    }
                }
                break;
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (resultCode == RESULT_OK){
            if (requestCode == IMAGE_FROM_GALLERY_CODE){
                ...
                Toast.makeText(getApplicationContext(), "ERROR AL EJECUTAR LA ACCION", Toast.LENGTH_SHORT).show();
            }
        }
    }
